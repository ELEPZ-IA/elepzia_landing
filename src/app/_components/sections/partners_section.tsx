...
const PartnersSection = () => {
    ...
    const [partnersRef1, partners1InView] = useInView({
        triggerOnce: true,
        threshold: 0.1
    });
    const [partnersRef2, partners2InView] = useInView({
        triggerOnce: true,
        threshold: 0.1
    });
        ...
        <div className='relative px-4 sm:px-6 md:px-8 pt-16 sm:pt-24 max-w-7xl mx-auto w-full flex flex-col items-center overflow-hidden'>
            ...
            <div className='relative z-10 flex flex-col justify-center items-center gap-6 sm:gap-8'>
                <motion.div
                    ...
                    animate={{
                        opacity: partners1InView ? 1 : 0,
                        x: partners1InView ? 0 : -50
                    }}
                ...
                <motion.div
                    ...
                    initial={{ opacity: 0, x: 50 }}
                    animate={{
                        opacity: partners2InView ? 1 : 0,
                        x: partners2InView ? 0 : 50
                    }}
