    ...
    return (
        <div className='relative overflow-x-hidden mt-10'>
            <motion.div
                ...
                className='w-[200px] h-[200px] rounded-full bg-gradient-to-r from-[#FFEB9E]/50 via-[#FFEB9E]/50 to-[#F38E79]/50 blur-[10px] pointer-events-none z-0 mt-10'
            />
            <section
                id='contact'
                className='relative w-full max-w-[40%] mx-auto px-4 py-16 flex flex-col items-center z-10'>
