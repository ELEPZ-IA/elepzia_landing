...
const EpisafeSection = () => {
    ...
    return (
        <SectionWrapper id='episafe'>
            <div className='flex flex-col justify-start items-center gap-6 h-[316px] md:h-auto p-4 px-6 sm:px-8 md:px-12 mt-60 relative overflow-hidden'>
                ...
                <motion.div
                    ...
                    className='px-8 py-3 bg-gradient-to-r from-white/5 to-white/2 rounded-[88px] border border-white/10 backdrop-blur-lg flex justify-center items-center gap-2.5'>
                ...
                <motion.div
                    ...
                    className="text-center text-[#d1d1d6] text-lg md:text-xl font-normal font-['Outfit'] leading-relaxed md:leading-loose">
                    Episafe is revolutionizing epilepsy care with advanced AI
                    and IoT solutions. Designed for{' '}
                    <br className='hidden md:block' /> safety, independence, and
                    peace of mind, Episafe empowers both patients{' '}
                    <br className='hidden md:block' /> and caregivers.
                </motion.div>
            </div>
            <div className='relative w-full max-w-screen-xl mx-auto mt-8 sm:mt-12 md:mt-24 px-4 sm:px-6 md:px-8 lg:px-4'>
...
const Content = ({ name, description }: ContentProps) => {
    return (
        <>
            ...
            <div className='mt-6 sm:mt-8 md:mt-0 md:absolute md:top-1/2 md:-translate-y-1/2 relative right-0 md:-right-16 lg:-right-32 w-[120px] sm:w-[150px] md:w-[200px] lg:w-[300px] mx-auto'>
                <Image
