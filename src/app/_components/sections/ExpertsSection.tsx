...
const ExpertsSection = () => {
    ...
    const expertsInView = useInView(expertsRef, {
        once: true,
        margin: '-100px'
    });
    ...
    const experts = [
        {
            name: t('experts.0.name'),
            role: t('experts.0.role'),
            description: t('experts.0.description'),
            image: '/images/ghassen.jpg'
        },
        {
            name: t('experts.1.name'),
            role: t('experts.1.role'),
            description: t('experts.1.description'),
            image: '/images/nadia.jpg'
        },
        {
            name: t('experts.2.name'),
            role: t('experts.2.role'),
            description: t('experts.2.description'),
                    ...
                    {experts.map((expert, index) => (
                        <motion.div
                            ...
                            <motion.div
                                ...
                                <h3 className='text-xl font-bold text-[#F38E79]'>
                                    {expert.name}
                                </h3>
