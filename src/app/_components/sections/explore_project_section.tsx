    ...
    return (
        <div className='flex flex-col justify-start items-center gap-6 h-[316px] md:h-auto p-4 mt-60 relative overflow-hidden'>
            ...
            <motion.div
                ...
                Episafe is revolutionizing epilepsy care with advanced AI and
                IoT solutions. Designed for <br className='hidden md:block' />{' '}
                safety, independence, and peace of mind, Episafe empowers both
                patients <br className='hidden md:block' /> and caregivers.
            </motion.div>
        </div>
    );
};
